package com.example.oauth2webservicesclientservice;
...
public class Oauth2WebservicesClientServiceApplication {

    public static void main(String[] args) {
        SpringApplication.run(Oauth2WebservicesClientServiceApplication.class, args);
    }
